...
const SummonerHeader = ({ profileIconId, name, summonerLevel, champion }) => {
  return (
    <React.Fragment>
      ...
      <div className="col-12 col-sm-12 col-md-4 col-lg-4">
        ...
        <div className="row justify-content-center">
          <div className="col-3">
            <ChampionImage champion={champion[0]} />
          </div>
          <div className="col-3">
            <ChampionImage champion={champion[1]} />
          </div>
          <div className="col-3">
            <ChampionImage champion={champion[2]} />
          </div>
        </div>
      </div>
    </React.Fragment>
